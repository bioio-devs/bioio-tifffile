...
import lxml.etree
import numpy as np
from bioio_types.dimensions import DimensionNames
from bioio_types.types import ArrayLike, PathLike, PhysicalPixelSizes
...
def get_dims_and_coords_from_ome(
    ...
    """
    from base_image_reader import Reader
